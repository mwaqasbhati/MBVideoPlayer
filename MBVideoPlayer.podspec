#
# Be sure to run `pod lib lint MBVideoPlayer.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/mwaqasbhati/MBVideoPlayer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mwaqasbhati' => 'm.waqas.bhati@hotmail.com' }
  s.source           = { :git => 'https://github.com/mwaqasbhati/MBVideoPlayer.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '13.0'
  s.swift_version = '5.0'
  s.source_files = 'MBVideoPlayer/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MBVideoPlayer' => ['MBVideoPlayer/Assets/*.png']
  # }
